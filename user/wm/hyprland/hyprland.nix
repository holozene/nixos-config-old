...

{
  ...
  home.packages = with pkgs; [
    ...
    libva-utils # video acceleration
    polkit_gnome # authentication agent
    hyprland-protocols # bridge gnome functionality
    gsettings-desktop-schemas # G(nome)Settings
    wlr-randr # wlroots randr
    wtype # cli controlled typing
    ...
    # wofi
    fuzzel # app launcher
    keepmenu # dmenu/rofi keepass frontend
    pinentry-gnome
    ...
    qt6.qtwayland
    xdg-utils # desktop-app integrations
    xdg-desktop-portal
    ...
    wlsunset
    brightnessctl # cli for device brightness
